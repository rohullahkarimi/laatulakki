...
export const graduationCapCustomizationOptions = ({
  ...
  "img": [
    ...
    {
      "original": "https://www.laatulakki.fi/images/graduation_cap/800/malli_ylioppilaslakki_4.jpg",
      "thumbnail": "https://www.laatulakki.fi/images/graduation_cap/200/malli_ylioppilaslakki_4.jpg",
      "originalAlt": "Ylioppilaslakki_malli",
      "thumbnailAlt": "Ylioppilaslakki_malli"
    },
    {
      "original": "https://www.laatulakki.fi/images/graduation_cap/800/malli_ylioppilaslakki_5.jpg",
      "thumbnail": "https://www.laatulakki.fi/images/graduation_cap/200/malli_ylioppilaslakki_5.jpg",
      "originalAlt": "Ylioppilaslakki_malli",
      "thumbnailAlt": "Ylioppilaslakki_malli"
    },
    {
  ...
  onOff: { badge: true, roundRibbonColor: true, cordColor: true, embroideryTextFront: true, embroideryTextBack: true },
  badge: [
    { name: {
      "fi": [
        {
    ...
    }, price: 0, enabled: true, stock: 100 },
    { name: {
      "fi": [
        {
          "name": "kristalli"
    ...
    }, price: 8, enabled: true, stock: 100 },
    { name: {
      "fi": [
        {
          "name": "tähti"
  ...
  roundRibbonColor: [
    ...
    },  color: "#ffcd59", price: 6, enabled: true, stock: 100 },
    { name: {
      "fi": [
        {
          "name": "hopea"
    ...
    },  color: "#e8e8e8", price: 6, enabled: true, stock: 100 },
  ],
  cordColor: [
    { name: {
      "fi": [
    ...
    },  color: "#000000", price: 0, enabled: true, stock: 100 },
    { name: {
      "fi": [
        {
          "name": "kulta"
    ...
    },  color: "#ffcd59", price: 3, enabled: true, stock: 100 },
    { name: {
      "fi": [
        {
          "name": "hopea"
