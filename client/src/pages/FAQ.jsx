...
const questions = [
    ...
    },
    {
        ...
        answerFi: 'Ylioppilaslakin tilaamisen ajankohta riippuu siitä, milloin ylioppilaskirjoitukset ovat jamilloin valmistujaisjuhlat järjestetään. Usein ylioppilaslakin tilaaminen kannattaa tehdähyvissä ajoin ennen valmistujaisjuhlia, jotta lakkia ei tarvitse tilata kiireessä ja riskimahdolliselle viivästykselle vähenee. Laatulakki kuitenkin toimittaa tilauksia viikonjokaisena päivänä postin aukioloaikojen mukaisesti ja tästä syystä saat tilaamasiylioppilaslakin käyttöösi jo muutaman päivän sisällä tilauksestasi!',
    ...
    },
    {
        ...
        answerFi: 'Ylioppilaslakki valitaan päänympärysmitan mukaan. Mittaa päänympäryksesisenttimetreinä otsalta, korvien yläpuolelta takaraivolle asti ja pyydä tarvittaessa kaveria taivanhempaa apuun. Laatulakin verkkokaupan koot vastaavat päänympäryksensenttimetrejä. On tärkeää, että ylioppilaslakki istuu hyvin päähän eikä ole liian tiukka tailiian löysä. Lakin pitää pysyä päässä ilman, että se puristaa tai valuu liikaa. Mikälipäänympärysmitta on kahden koon välissä, on hyvä valita hieman isompi koko, esimerkiksijos mitattu päänympärys on 56,4 cm, sinun kannattaa valita yo-lakki koossa 57. On parempivalita hieman isompi koko myös siitä syystä, että vuosien kuluessa pää yleensä vielähieman kasvaa. Mikäli vahingossa tilaat väärän kokoisen lakin voit halutessasi palauttaalakin ja vaihtaa sen sopivaan. Laatulakin verkkosivuilta on myös mahdollista tilatakorkkiliuskoja, joilla saat hieman liian isosta lakista sopivan kokoisen.Jos olet epävarma lakin oikeasta koosta, kannattaa kysyä neuvoa info@laatulakki.fi. Meautamme sinua mielellämme oikean kokoisen lakin valinnassa.',
    ...
    },
    {
        ...
        answerFi: 'Useat eri tekijät voivat vaikuttaa ylioppilaslakin hintaan, kuten lakin malli, materiaalit javalmistaja. Yleisesti ottaen yksinkertaisemmat ja perinteisemmät lakkimallit ovathalvempia kuin erikoisemmat tai moderneimmat mallit. Laatulakki-verkkokaupasta saatlaadukkaista materiaaleista valmistetun perinteisen suomalaisen ylioppilaslakin erittäinedulliseen hintaan 44,90 €.',
    ...
    },
    {
        ...
        answerFi: 'Kenties olet nähnyt isovanhempiesi kellastuneen ylioppilaslakin? Elämän jäljet jakellastuminen kuuluvat ylioppilaslakin elinkaareen, mutta lakkia voi myös halutessaanpuhdistaa samettiharjalla kevyesti harjaten tai vaahtomuovin palalla jatahranpoistoaineella. Lakki kannattaa kuitenkin säilyttää omassa laatikossaan, sillä sesuojaa yo-lakkia pölyltä. Sormenjäljet lipasta saat pyyhittyä puhtaalla puuvillakankaalla taineutraalilla saippuaveteen kostutetulla liinalla. Ylioppilaslakkia ei tule kuitenkaan pestäpesukoneessa tai liottaa. Jos ylioppilaslakkisi kuitenkin kastuu, niin anna sen kuivuavuorokausi huoneenlämmössä ennen laatikkoon laittamista.',
    ...
    },
    {
        ...
        answerFi: 'Ylioppilaslakin käyttö vappujuhlissa juontaa juurensa 1900-luvun alkuun, jolloin opiskelijatalkoivat juhlistaa vappua ylioppilaslakin kanssa. Vappu oli jo tuolloin suosittu juhla, muttaylioppilaslakin käyttö vapun juhlintaan alkoi levitä ensin Helsingin yliopistosta muihinyliopistoihin ja myöhemmin myös muihin oppilaitoksiin. Tästä lähtien ylioppilaslakki onollut osa suomalaista vappuperinnettä.Vappu on työväen ja kevään saapumisen juhla. Ylioppilaslakin käyttö vappuna edustaaakateemisia arvoja ja symboloi opiskelijaelämää, sekä sitä, että opiskelija on suorittanutlukion oppimäärän ja valmistunut ylioppilaaksi. Vappuna järjestetään usein erilaisia juhlia jatapahtumia, joissa ylioppilaslakin käyttö on yleistä. Tämä juhla on perinteisesti yhdistettyopiskelijoiden juhlaan, ja juuri ylioppilaslakki on ollut opiskelijoiden tunnusmerkki.Vappuna opiskelijat ovat usein järjestäneet puistojuhlia, piknikkejä, kulkueita ja muitatapahtumia, ja ylioppilaslakki on ollut näissä juhlissa yleinen näky sekä nuorilla ettävanhemmilla ylioppilastutkinnon suorittaneilla.',
