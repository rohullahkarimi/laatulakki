                ...
                <Col md={12}>
                    <section id="projects" className="projects-section">
                        ...
                        <div className="row align-items-center no-gutters mb-4 mb-lg-5">
                            ...
                            <img className="img-fluid mb-3 mb-lg-0" src="https://www.laatulakki.fi/public/images/ylioppilaslakki_ruusu.JPG" alt=""/>
                        ...
                        <div className="row justify-content-center no-gutters mb-5 mb-lg-0">
                            ...
                            <img className="img-fluid" src="https://www.laatulakki.fi/public/images/rohullah_karimi_afghanistan.JPG" alt=""/>
