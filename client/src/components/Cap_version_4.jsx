...
function Ylioppilaslakki(props) {
  ...
  const { nodes, materials } = useGLTF('./models/cap_version_4.gltf')
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group scale={0.071} visible={false} >
      ...
      <mesh geometry={nodes.first_002.geometry} material={materials['Material.005']} visible={true}/>
      <mesh geometry={nodes.Diamond001.geometry} material={materials['diamond.001']} visible={false} />
      <mesh geometry={nodes.Diamond001_1.geometry} material={materials.gold} visible={false} />
...
useGLTF.preload('./models/cap_version_4.gltf')
